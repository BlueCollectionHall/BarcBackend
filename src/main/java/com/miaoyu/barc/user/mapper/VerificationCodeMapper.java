...
public interface VerificationCodeMapper {
    ...
    @Insert("INSERT INTO verification_code (unique_id, code, username, scenario, create_at, expiration_at, used) VALUES (#{unique_id}, #{code}, #{username}, #{scenario}, NOW(), DATE_ADD(NOW(), INTERVAL #{minute} MINUTE), false)")
    boolean insert(VerificationCodeModel request, @Param("minute") int minute);
